		...
		<ul class = 'bjqs'>
			...
			<li>
				...
				<div class = "service">
					...
					<div class = "description">
						Highly experienced in building websites in more than one language.
					</div>
				</div>
			...
			<li>
				...
				<div class = "service">
					...
					<div class = "description">
						...
						With my experience in mobile design we can work together to find an optimal solution for your business.
					</div>
				</div>
